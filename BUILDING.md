...
git apply /path/to/patches/etk-rpcs3-gtk-edition-0.8.3-dev.patch
```
...
use `git checkout a1deb2921` — v0.0.41-19638 — with `patches/etk-rpcs3-gtk-edition-0.8.3-dev.patch`.)
