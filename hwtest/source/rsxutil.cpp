// rsxutil.cpp — screen/flip plumbing, adapted from the PSL1GHT rsxtest sample
// (samples/graphics/rsxtest/source/rsxutil.cpp). Resolution preference is
// 720p first so RPCS3 and typical HDTV setups land on the same 1280x720 layout.
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
...
void init_screen(void *host_addr,u32 size)
{
	...
	context = rsxInit(DEFAULT_CB_SIZE,size,host_addr);
